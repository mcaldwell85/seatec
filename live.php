					...
					//	if(isset($_GET['id']) ) {
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul id="<?php	echo $site_row->description	?>" class="side-nav-child">
								...
								<?php
										$site_id = $site_row->id;
										$camera_id = $site_row->camera_id;
										$camera_sql = "SELECT * FROM cameras WHERE ".$where." AND site_id = '$site_id' ";
										$camera_result = mysql_query($camera_sql) or die(mysql_error());
										$camera_num = mysql_num_rows($camera_result);
										
										while ($camera_row = mysql_fetch_object($camera_result)) {
										$camera_url = $camera_row->url ?>
								
                                <li class="side-nav-item">
                                    <a href="#<?php	echo $camera_row->description ?>">
                                        <i class="nav-item-icon icon ion-laptop"></i>
										
                                        <?php	echo $camera_row->description ?>
                ...
                <section id="content-main" class="content-main">
                    ...
                    <div class="content-app fixed-header">
                        ...
                        <div class="app-body">
							...
							$site_id = $site_row->id;
							$cameraUrl_sql = "SELECT * FROM cameras WHERE ".$where."  ";
										$cameraUrl_result = mysql_query($cameraUrl_sql) or die(mysql_error());
										$cameraUrl_num = mysql_num_rows($cameraUrl_result);
										
										while ($cameraUrl_row = mysql_fetch_object($cameraUrl_result)) {	?>

                            
<SCRIPT LANGUAGE="JavaScript"> 

var BaseURL; 
BaseURL = "<?php echo $cameraUrl_row->url ?>";

var DisplayWidth = "420"; 
var DisplayHeight = "320"; 

var File = "<?php echo $cameraUrl_row->url ?>";
