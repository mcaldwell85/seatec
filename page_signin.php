    ...
    <section id="wrapper" class="container">
        <section id="signin" class="sign-wrapper signin transition-layout">
                    ...
                    <div class="sign-container">
                        <form role="form" action="" method="post">
                            <div class="form-group">
                                <input name="login-username" id="login-username" alt="Username"  type="text"   maxlength="80"  value="Username" onblur="if(this.value=='') this.value='Username';" onfocus="if(this.value=='Username') this.value='';">
                            </div><!-- /form-group -->
                            <div class="form-group">
                                <input name="login-password" id="login-password" alt="Password" type="password"  maxlength="80" onfocus="if(this.value=='Password') this.value='';">
                            </div><!-- /form-group -->
                            <div class="form-group">
                                <button type="submit" id="login-button" class="btn btn-primary btn-block" value="Login" name="login-submit">Sign in</button>
                            </div><!-- /form-group -->
                            <div class="form-group">
            ...
            <div class="sign-footer">
                <a href="#signup" data-toggle="transition-layout" class="btn btn-link text-inverse">Sign Up to InvisoVideo</a>
            ...
            <div class="row">
                <div class="col-md-offset-4 col-sm-offset-0 col-xs-offset-0 col-md-4 col-sm-12 col-xs-12">
                    <div class="sign-brand">
                        ...
                        <h1 class="sign-brand-name">Sign Up InvisoVideo</h1>
                    </div><!-- /sign-brand -->
                    <div class="sign-container">
