...
$sql = "SELECT c.url as name, c.site_id, s.description as description FROM cameras c JOIN sites s ON c.site_id = s.id WHERE ".$where."  ORDER BY c.id";
...
<?php
	...
	?>
	<tr class="gridRow">
		<td><input name="checkbox[]" type="checkbox" class="checkbox" value="<?php echo $row->name; ?>"></td>
